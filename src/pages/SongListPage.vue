  ...
  <div class="table">
    <div class="container">
      <div class="handle-box">
        ...
        <el-input v-model="select_word" size="mini" placeholder="请输入关键字" class="handle-input">
    ...
    <el-table size="mini" border style="width: 100%" height="670px" :data="data" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="简介">
        <template slot-scope="scope">
          <p style="height: 80px ;overflow: inherit;text-indent: 2em;">{{scope.row.introduction}}</p>
        </template>
      </el-table-column>
    ...
    <el-dialog title="添加歌单" :visible.sync="centerDialogVisible" width="400px" center>
      ...
      <el-button size="mini" @click="addSongList">确认上传</el-button>
    </span>
    </el-dialog>
...
export default {
  ...
  methods: {
    ...
    addSongList () {
      ...
      params.append('pic', '/img/songListPic/pdx.jpg')
